...
consumerKey = 'VjnmmREzcsJXMq8PbE8ALktet'
consumerSecret = 'YRuKVaqf2mUxw31UJPK4aNBZQtJtwJQ2EXD2ZILsquz3yBF2u7'
accessToken = '1439567089681895426-1HwILDrG439GOQLoMDscrwmkpqEqjD'
accessTokenSecret = 'zaZVrKScZRBXAQV1uSrosOFHiUUBYSxa0O1LE5AUA6uh3'
	...
	if choice=="Tweet Analyzer":
		...
		if st.button("Analyze"):
			...
			if Analyzer_choice == "Show Recent Tweets":
				...
				st.success("Fetching lastest tweets")
